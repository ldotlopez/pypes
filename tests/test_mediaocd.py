...
from pypes.elements import SampleSrc, StoreSink, CustomTransformer, Debugger
from pypes.mediaocd import GuessItParser, Normalizer, NearestMatch
...
NEAREST_MATCH_LIST = (
    'El Mentalista', 'Anatomía de grey', 'American Horror Story'
)
...
class TestMediaOCD(unittest.TestCase):
    ...
    def test_normalize(self):
        inouts = (
            (
                'ShowWithBadNumbering710.avi',
                'ShowWithBadNumbering s7e10.avi'
            ),
            (
            ...
            (
                'EMentalista720p522 [www.newpct.com].mkv',
                'EMentalista s5e22.mkv'
            )
        )
